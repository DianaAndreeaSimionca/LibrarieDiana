...
if (isset($_POST['modifica']))
{
    ...
    {
        $sql = "UPDATE comentarii SET nume_utilizator='".$_POST['nume_utilizator']."','".$_POST['adresa_email']."','".$_POST['comentariu']."' WHERE id_comentariu=".$_POST['id_comentariu'];
        mysqli_query($db, $sql);
        print "Comentariul a fost modificat!";
    }
}//if

if (isset($_POST['seateaza_moderate']))
{
