...
<form action="forms_moderate_opinions.php" method="post">
    <div style="width: 500px; border: 1px solid #ffffff; background-color: #F9F1E7; padding: 5px">
        ...
        <hr size="1"><a href="mailto:<?=$row['adresa_email']?>"><?=$row['nume_utilizator']?></a><br>
    </div>
...
<form action="forms_moderate_opinions.php" method="post">
    ...
    <input type="submit" name="seteaza_moderare" value="Setteaza aceste comentarii ca fiind moderate">
</form>
<?php
}
else
